...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "chnsyntext1_train": ("abcnet/images", "abcnet/annotations/chn_syntext.json"),
    "chnsyntext1_val": ("abcnet_val/images", "abcnet_val/annotations/val.json"),
    "rects_train": ("abcnet_rects/ReCTS_train_images", "abcnet_rects/annotations/rects_train.json"),
    "rects_val": ("abcnet_rects/ReCTS_test_images", "abcnet_rects/annotations/rects_val.json"),
}
